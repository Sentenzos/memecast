...
Бесплатные мем-алерты для OBS: публичная страница зрителей, очередь алертов, озвучка текста, административная медиатека, IP-модерация и живой аудиоплеер стримера.
...
Для живого аудио Compose также запускает MediaMTX. UDP-порт `8890` должен быть открыт на VPS. Домашний клиент находится в папке `broadcaster`; подробности — в `broadcaster/README.md`.
