...
export const streamers = sqliteTable("streamers", {
  ...
  overlayTextWidth: integer("overlay_text_width").notNull().default(480),
  overlayTextHeight: integer("overlay_text_height").notNull().default(160),
  overlayTextFontSize: integer("overlay_text_font_size").notNull().default(28),
